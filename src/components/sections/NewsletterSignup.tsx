  ...
  return (
    <section className="bg-travel-800 py-12">
      <div className="max-w-2xl mx-auto px-4 text-center">
        ...
        {submitted ? (
          <div className="flex items-center justify-center gap-2 text-sun-300">
            <CheckCircle size={20} />
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-4 py-2.5 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/40 focus:outline-none focus:border-sun-300 text-sm"
              required
            />
            <Button type="submit" variant="sun" size="md">
              {t.home.subscribeBtn}
            </Button>
          </form>
        )}
