...
const PLAYLISTS: Playlist[] = [
  { id: '1', title: 'Raizal.tv Weekly Mix', description: 'The best of island music this week', trackCount: '20 tracks', curator: 'Raizal.tv Editors', gradient: 'from-travel-700 to-skybrand-700' },
  ...
  { id: '4', title: 'Throwback Caribbean Classics', description: 'The songs that shaped the islands', trackCount: '25 tracks', curator: 'Raizal.tv Archive', gradient: 'from-palm-700 to-travel-800' },
  ...
  { id: '6', title: 'Acoustic Coast Sessions', description: 'Quiet beauty, guitar, and the sea', trackCount: '10 tracks', curator: 'Jevonte Williams', gradient: 'from-travel-600 to-skybrand-700' },
];
