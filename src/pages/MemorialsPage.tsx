...
export function MemorialsPage() {
  ...
  return (
    <div className="app-page">
      {/* Hero */}
      <div className="bg-travel-900 py-14 text-white">
        <div className="content-shell text-center">
          <Heart size={32} className="text-sun-300 mx-auto mb-3" />
      ...
      <div className="content-shell py-10">
        ...
        {/* Submit callout */}
        <div className="modern-card p-6 flex items-start gap-4 max-w-2xl mx-auto">
          <Upload size={24} className="text-travel-600 shrink-0 mt-1" />
          <div>
            <h3 className="font-display text-xl font-bold text-ink-900">{t.memorials.submitRemembrance}</h3>
            <p className="text-ink-600 mt-1">{t.memorials.submitSub}</p>
