...
export function MusicPage() {
  ...
  return (
    <div className="bg-white">
      {/* Hero */}
      <div className="bg-gradient-to-br from-navy-950 via-navy-900 to-coral-900 py-14 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-2 mb-3">
            <Music size={18} className="text-coral-400" />
            <span className="text-coral-400 text-xs font-bold uppercase tracking-widest">Raizal.tv Music</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-5">
            <div className="flex items-center gap-2 mb-1">
              <Disc3 size={18} className="text-coral-500" />
              <span className="text-coral-500 text-xs font-bold uppercase tracking-widest">Weekly Chart</span>
            </div>
            <h2 className="font-display text-3xl font-bold text-navy-900">{t.music.chart}</h2>
            <p className="text-navy-500 text-sm mt-0.5">{t.music.chartSub}</p>
          </div>
      ...
      <section className="bg-navy-950 py-10">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-3 mb-5 flex items-start gap-2">
            <span className="text-turquoise-400 text-xs shrink-0 mt-0.5">ℹ</span>
      ...
      <section className="bg-gradient-to-r from-coral-600 to-navy-900 py-12 text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Button variant="coral" size="lg">{t.music.submitMusic}</Button>
